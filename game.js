(() => {
  ...
  __name(E, "E");
  a(E, "rgb");
  var fr2 = a((i, t, l) => v.fromHSL(i, t, l), "hsl2rgb");
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  loadPedit("mogi", "sprites/mogi2.pedit");
  loadPedit("avocado", "sprites/avocado.pedit");
  loadSound("avocado-o", "sounds/avocado-o.mp3");
  loadSound("o", "sounds/o.mp3");
  loadSound("mogi-buzz", "sounds/mogi-buzz.mp3");
  loadSound("mogi-clap", "sounds/mogi-clap.mp3");
